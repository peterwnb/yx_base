...
public class AESCoderUtil {
	...
	{
		String json_str = JSON.toJSONString(tokenVo);
	 ...
	 * @throws Exception
	 */
	public static ServerToken decodeAMStoken(String aMServerToken) throws Exception
	{
		ServerToken amServerTokenPOJO = null;
		...
		amServerTokenPOJO = JSON.parseObject(token_str, ServerToken.class);
		/**
		 * Token过期一小时
		 */
	...
	public static void main(String[] args) throws Exception
	{
		...
		ServerToken ap = new ServerToken("2c9081a33e775bc1013e775cc6890001",
		...
		//反向生成TOkenPojo
		ServerToken tokenPOJO = AESCoderUtil
