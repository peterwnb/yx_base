...
public class ValidatorUtils {
	 ...
	 * 正则表达式：验证手机号
	 */
	private static final String REGEX_MOBILE = "^(177|(13[0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$";
	...
	public static boolean isBirthday(String birthday) {
		return Pattern.matches(REGEX_IP_ADDR, birthday);
	}
	
	public static void main(String[] args) {
		boolean f = ValidatorUtils.isMobile("17771810425");
